...
public class ClientProxyHttpClientHttp {
	// 代理服务器
	final static String proxyHost = "117.191.11.113";
...
//			host:zqdn.781z.cn
//			user-agent:Mozilla/5.0 (Linux; Android 6.0.1; Redmi 4A Build/MMB29M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/57.0.2987.132 Mobile Safari/537.36
		
		
//		httpReq.setHeader("User-Agent",
//				"Mozilla/5.0 (Linux; Android 6.0.1; Redmi 4A Build/MMB29M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/57.0.2987.132 Mobile Safari/537.36");
//		httpReq.addHeader("accept", "*/*");
//		httpReq.addHeader("accept-encoding", "gzip");
//		httpReq.addHeader("charset", "UTF-8");
//		httpReq.addHeader("connection", "Keep-Alive");
//		httpReq.addHeader("content-length", "114");
//		httpReq.addHeader("content-type", "application/x-www-form-urlencoded");
//		httpReq.addHeader("host", "zqdn.781z.cn");
